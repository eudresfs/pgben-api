 ...
 *
 *             node scripts/generate-whatsapp-keys.js {passphrase}
 *
 */
...
if (!passphrase) {
  throw new Error(
    "Passphrase is empty. Please include passphrase argument to generate the keys like: node scripts/generate-whatsapp-keys.js {passphrase}"
  );
}
...
WHATSAPP_PRIVATE_KEY="${keyPair.privateKey}"
