...
async function runSeeds() {
  ...
  try {
    ...
    console.log('📦 Incluindo: usuários, perfis, unidades, setores, tipos de benefício, permissões');
    ...
    console.log('✅ Seed de estruturas de tipos de benefício executado com sucesso!');
    ...
    console.log('✅ Seeds essenciais: usuários, perfis, unidades, setores, tipos de benefício, permissões');
    console.log('✅ Seeds de referência: categorias, modelos e requisitos de documentos');
