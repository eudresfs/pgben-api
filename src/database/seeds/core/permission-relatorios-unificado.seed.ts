...
export class PermissionRelatoriosUnificadoSeed {
  private static readonly logger = new Logger(
    PermissionRelatoriosUnificadoSeed.name,
  );
  ...
  static async run(dataSource: DataSource): Promise<void> {
    this.logger.log(
      'Iniciando seed de permissões do módulo de relatórios unificado...',
    );
    ...
    try {
      ...
      this.logger.log(
        'Seed de permissões do módulo de relatórios unificado concluído com sucesso!',
      );
    } catch (error) {
      this.logger.error(
        `Erro ao executar seed de permissões de relatórios unificado: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  private static async createCompositePermission(
    ...
    this.logger.log(
      'Permissão composta relatorios-unificado.* criada com sucesso.',
    );
  }
  ...
  private static async createGranularPermissions(
    ...
    this.logger.log(
      'Criando permissões granulares do módulo de relatórios unificado...',
    );
    ...
    this.logger.log(
      `${permissions.length} permissões granulares do módulo de relatórios unificado processadas.`,
    );
  }
