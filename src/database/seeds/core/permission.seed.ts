...
export class PermissionSeeder implements Seeder {
  ...
  async run(dataSource: DataSource): Promise<void> {
    ...
    try {
      ...
      this.logger.log(
        `Colunas encontradas na tabela permissao: ${columnNames.join(', ')}`,
      );

      // Criar permissões raiz para cada módulo diretamente com SQL
      this.logger.log(
        'Criando permissões raiz dos módulos usando SQL direto...',
      );
      ...
      const moduleRoots = [
        {
          nome: 'usuario.*',
          descricao: 'Todas as permissões do módulo de usuários',
          modulo: 'usuario',
          acao: '*',
        },
        {
          nome: 'cidadao.*',
          descricao: 'Todas as permissões do módulo de cidadãos',
          modulo: 'cidadao',
          acao: '*',
        },
        {
          nome: 'beneficio.*',
          descricao: 'Todas as permissões do módulo de benefícios',
          modulo: 'beneficio',
          acao: '*',
        },
        {
          nome: 'solicitacao.*',
          descricao: 'Todas as permissões do módulo de solicitações',
          modulo: 'solicitacao',
          acao: '*',
        },
        {
          nome: 'documento.*',
          descricao: 'Todas as permissões do módulo de documentos',
          modulo: 'documento',
          acao: '*',
        },
        {
          nome: 'auditoria.*',
          descricao: 'Todas as permissões do módulo de auditoria',
          modulo: 'auditoria',
          acao: '*',
        },
        {
          nome: 'unidade.*',
          descricao: 'Todas as permissões do módulo de unidades',
          modulo: 'unidade',
          acao: '*',
        },
        {
          nome: 'relatorio.*',
          descricao: 'Todas as permissões do módulo de relatórios',
          modulo: 'relatorio',
          acao: '*',
        },
        {
          nome: 'configuracao.*',
          descricao: 'Todas as permissões do módulo de configurações',
          modulo: 'configuracao',
          acao: '*',
        },
        {
          nome: 'notificacao.*',
          descricao: 'Todas as permissões do módulo de notificações',
          modulo: 'notificacao',
          acao: '*',
        },
        {
          nome: 'metrica.*',
          descricao: 'Todas as permissões do módulo de métricas',
          modulo: 'metrica',
          acao: '*',
        },
        {
          nome: 'integrador.*',
          descricao: 'Todas as permissões do módulo de integrador',
          modulo: 'integrador',
          acao: '*',
        },
        {
          nome: 'judicial.*',
          descricao: 'Todas as permissões do módulo judicial',
          modulo: 'judicial',
          acao: '*',
        },
        {
          nome: 'ocorrencia.*',
          descricao: 'Todas as permissões do módulo de ocorrências',
          modulo: 'ocorrencia',
          acao: '*',
        },
        {
          nome: 'pagamento.*',
          descricao: 'Todas as permissões do módulo de pagamentos',
          modulo: 'pagamento',
          acao: '*',
        },
        {
          nome: 'recurso.*',
          descricao: 'Todas as permissões do módulo de recursos',
          modulo: 'recurso',
          acao: '*',
        },
        {
          nome: 'relatorios-unificado.*',
          descricao: 'Todas as permissões do módulo de relatórios unificado',
          modulo: 'relatorios-unificado',
          acao: '*',
        },
      ];
      ...
      this.logger.error(
        `Erro ao executar seed de permissões: ${error.message}`,
      );
      throw error;
    }
  }
  ...
  private async runModuleSeeders(
    ...
    try {
      ...
      this.logger.error(
        `Erro ao executar seeders de módulos: ${error.message}`,
      );
      throw error;
    }
  }
