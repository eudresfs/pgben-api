        ...
        schema_estrutura: {
          publico_prioritario: {
            ...
            validation: {
              type: 'enum',
              enum: [
                'familias_criancas_adolescentes',
                'familias_gestantes_nutrizes',
                'familias_idosos',
                'mulheres_vitimas_violencia_domestica',
                'familias_pessoas_deficiencia',
                'familias_atingidas_calamidade_publica',
                'familias_situacao_risco_vulnerabilidade',
              ],
            },
          },
          especificacoes: {
