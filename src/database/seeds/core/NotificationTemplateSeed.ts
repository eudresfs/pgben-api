...
export class NotificationTemplateSeed {
  public static async run(dataSource: DataSource): Promise<void> {
    ...
    try {
      ...
      console.log(
        'Seed de templates de notificação pulado temporariamente para resolver problemas com a criação da tabela.',
      );
      console.log(
        'Este seed deverá ser executado manualmente após a criação da tabela via migration.',
      );
