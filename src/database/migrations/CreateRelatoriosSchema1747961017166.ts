...
export class CreateRelatoriosSchema1747961017166 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE INDEX IF NOT EXISTS "IDX_template_nome" ON "relatorio_template" ("nome");
      CREATE INDEX IF NOT EXISTS "IDX_template_tipo" ON "relatorio_template" ("tipo");
      CREATE INDEX IF NOT EXISTS "IDX_template_ativo" ON "relatorio_template" ("ativo");
      CREATE INDEX IF NOT EXISTS "IDX_template_parametros" ON "relatorio_template" USING GIN ("parametros_requeridos");
      CREATE INDEX IF NOT EXISTS "IDX_template_filtros" ON "relatorio_template" USING GIN ("filtros_disponiveis");
    `);
