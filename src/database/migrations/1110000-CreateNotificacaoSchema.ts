 ...
 * @date 19/05/2025
 */
export class CreateNotificacaoSchema1685468879192 implements MigrationInterface {
  name = 'CreateNotificacaoSchema1685468879192';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    if (!notificationTemplateExists[0].exists) {
      ...
      CREATE INDEX IF NOT EXISTS "IDX_template_codigo" ON "notification_template" ("codigo");
      CREATE INDEX IF NOT EXISTS "IDX_template_tipo" ON "notification_template" ("tipo");
      CREATE INDEX IF NOT EXISTS "IDX_template_ativo" ON "notification_template" ("ativo");
      CREATE INDEX IF NOT EXISTS "IDX_template_categoria" ON "notification_template" ("categoria");
      CREATE INDEX IF NOT EXISTS "IDX_template_prioridade" ON "notification_template" ("prioridade");
