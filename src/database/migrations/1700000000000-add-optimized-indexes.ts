...
export class AddOptimizedIndexes1700000000000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS idx_composicao_familiar_cidadao_id`);
