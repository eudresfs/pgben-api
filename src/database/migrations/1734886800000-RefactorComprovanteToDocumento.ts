 ...
 */
export class RefactorComprovanteToDocumento1734886800000
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    console.log(
      '✅ Migração RefactorComprovanteToDocumento executada com sucesso',
    );
    console.log('📝 Tabela comprovante_pagamento removida');
    console.log(
      '🔗 Campo comprovante_id mantido na tabela pagamento para referência ao documento',
    );
  }
