 ...
 */
export class AddVencimentoRegularizacaoPagamento1750500000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.addColumn(
      ...
      new TableColumn({
        ...
        type: 'date',
        isNullable: true,
        comment: 'Data de vencimento do pagamento por falta de documentação (Aluguel Social)'
      })
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Remove índices
    await queryRunner.query(`DROP INDEX IF EXISTS "idx_pagamento_status_vencimento"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "idx_pagamento_data_vencimento"`);
