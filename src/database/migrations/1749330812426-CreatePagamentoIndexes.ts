...
export class CreatePagamentoIndexes1749330812426 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_liberado_por_created_at`);
    ...
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_metodo_pagamento`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_status_data_liberacao`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_data_liberacao`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_liberado_por`);
    await queryRunner.query(`DROP INDEX IF EXISTS idx_pagamento_info_bancaria_id`);
