...
import { DocumentFilterService, IValidacaoFiltros } from '../document-filter.service';
...
describe('DocumentFilterService', () => {
  ...
  beforeEach(async () => {
    ...
    // Reset mocks
    jest.clearAllMocks();
    mockDocumentoRepository.createQueryBuilder.mockReturnValue(mockQueryBuilder);
  });
  ...
  describe('validarFiltros', () => {
    ...
    it('deve gerar aviso para muitos cidadãos', async () => {
      const cidadaoIds = Array.from({ length: 150 }, (_, i) => 
