...
export class NotificacaoProativaScheduler {
  ...
  async obterStatusJobs() {
    return {
      ...
      jobs: [
        {
          nome: 'verificacao-prazos',
          ativo: true,
          frequencia: 'A cada 15 minutos',
        },
        {
          nome: 'verificacao-prazos-criticos',
          ativo: true,
          frequencia: 'A cada 5 minutos',
        },
        {
          nome: 'monitoramento-sistema',
          ativo: this.isProducao,
          frequencia: 'A cada 30 minutos',
        },
        {
          nome: 'verificacao-saude-sistema',
          ativo: true,
          frequencia: 'A cada 5 minutos',
        },
        ...
        {
          nome: 'processamento-grupos-15min',
          ativo: true,
          frequencia: 'A cada 15 minutos',
        },
        {
          nome: 'processamento-grupos-30min',
          ativo: true,
          frequencia: 'A cada 30 minutos',
        },
        {
          nome: 'processamento-grupos-1h',
          ativo: true,
          frequencia: 'A cada hora',
        },
        {
          nome: 'processamento-grupos-2h',
          ativo: true,
          frequencia: 'A cada 2 horas',
        },
        {
          nome: 'processamento-grupos-diario',
          ativo: true,
          frequencia: 'Diário às 9h',
        },
        {
          nome: 'relatorio-diario',
          ativo: this.isProducao,
          frequencia: 'Diário às 23h',
        },
        {
          nome: 'relatorio-semanal',
          ativo: this.isProducao,
          frequencia: 'Segundas às 8h',
        },
        {
          nome: 'otimizacao-indices',
          ativo: this.isProducao,
          frequencia: 'Domingos às 3h',
        },
        {
          nome: 'verificacao-integridade',
          ativo: this.isProducao,
          frequencia: 'Mensal dia 1 às 4h',
        },
      ],
    };
  }
