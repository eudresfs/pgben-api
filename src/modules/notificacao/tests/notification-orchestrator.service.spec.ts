...
describe('NotificationOrchestratorService', () => {
  ...
  beforeEach(async () => {
    ...
    sseHealthCheckService = module.get<SseHealthCheckService>(
  ...
  describe('Inicialização', () => {
    ...
    it('deve inicializar com configurações corretas', async () => {
      ...
      expect(configService.get).toHaveBeenCalledWith(
        'ABLY_CIRCUIT_BREAKER_THRESHOLD',
      );
    });
  });
  ...
  describe('sendNotification', () => {
    ...
    describe('Quando Ably falha', () => {
      ...
      it('deve fazer fallback para SSE', async () => {
        ...
        expect(sseService.sendNotificationToUser).toHaveBeenCalledWith(
          userId,
          mockNotification,
        );
      });
  ...
  describe('forceDeliveryMethod', () => {
    ...
    it('deve forçar uso do Ably', async () => {
      ...
      const result = await service.forceDeliveryMethod(
        'ably',
        userId,
        mockNotification,
      );
