...
export class EscalacaoAprovacaoService {
    ...
    try {
      ...
      const dadosEscalacao: DadosEscalacao = {
        ...
        metadados: {
          ...
          tipoAcao: solicitacao.acao_critica?.codigo as TipoAcaoCritica,
          usuarioEscalacao,
  ...
  private verificarCondicoesRegra(
    ...
    if (condicoes.tiposAcao && !condicoes.tiposAcao.includes(solicitacao.acao_critica?.codigo as TipoAcaoCritica)) {
      return false;
    }
