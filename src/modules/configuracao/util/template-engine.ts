...
export class TemplateEngine {
  ...
  private static templatesCompilados = new Map<string, HandlebarsTemplateDelegate>();
   ...
   */
  async render(templateString: string, dados: Record<string, any>, opcoes: { sanitize?: boolean } = {}): Promise<string> {
    try {
   ...
   */
  static renderizar(templateString: string, dados: Record<string, any>, templateId: string): string {
    try {
   ...
   */
  static validarVariaveis(templateString: string, variaveis: string[]): string[] {
