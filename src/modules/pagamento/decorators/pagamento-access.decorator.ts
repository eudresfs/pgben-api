 ...
 * async findAll() { ... }
 */
export const PerfisPermitidos = (...perfis: string[]) =>
 ...
 */
export const VerificarUnidade = (verificar: boolean = true) =>
  SetMetadata(UNIDADES_KEY, verificar);
 ...
 */
export const OperadorOuAdmin = () =>
  PerfisPermitidos('operador', 'admin', 'super_admin');
 ...
 * async getLogs() { ... }
 */
export const AuditorOuAdmin = () =>
  PerfisPermitidos('auditor', 'admin', 'super_admin');
