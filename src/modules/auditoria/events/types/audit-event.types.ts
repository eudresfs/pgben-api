...
export interface EntityAuditEvent extends BaseAuditEvent {
  eventType: AuditEventType.ENTITY_CREATED | AuditEventType.ENTITY_UPDATED | 
             AuditEventType.ENTITY_DELETED | AuditEventType.ENTITY_ACCESSED;
...
export interface SecurityAuditEvent extends BaseAuditEvent {
  eventType: AuditEventType.SUCCESSFUL_LOGIN | AuditEventType.FAILED_LOGIN | 
             AuditEventType.LOGOUT | AuditEventType.PASSWORD_CHANGED |
             AuditEventType.PASSWORD_RESET | AuditEventType.ACCOUNT_LOCKED |
             AuditEventType.TOKEN_REFRESH | AuditEventType.PERMISSION_CHANGED |
...
export interface SystemAuditEvent extends BaseAuditEvent {
  eventType: AuditEventType.SYSTEM_ERROR | AuditEventType.SYSTEM_WARNING | 
             AuditEventType.SYSTEM_INFO | AuditEventType.BACKUP_CREATED |
             AuditEventType.MAINTENANCE_START | AuditEventType.MAINTENANCE_END;
}
...
export interface SensitiveDataAuditEvent extends BaseAuditEvent {
  eventType: AuditEventType.SENSITIVE_DATA_ACCESSED | AuditEventType.SENSITIVE_DATA_EXPORTED |
             AuditEventType.SENSITIVE_DATA_DELETED | AuditEventType.SENSITIVE_DATA_ANONYMIZED |
             AuditEventType.DATA_CONSENT_GIVEN | AuditEventType.DATA_CONSENT_REVOKED;
 ...
 */
export type AuditEvent = EntityAuditEvent | SecurityAuditEvent | SystemAuditEvent | SensitiveDataAuditEvent | BaseAuditEvent;
