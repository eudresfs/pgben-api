...
/**
 * Entidade para armazenar dados específicos do cidadão para Benefício por Morte
 *
 * Armazena informações específicas necessárias para a solicitação do benefício
 * de Benefício por Morte, como dados do falecido, tipo de urna, etc.
 */
@Entity('dados_funeral')
@Index(['solicitacao_id'], { unique: true })
export class DadosAtaude {
