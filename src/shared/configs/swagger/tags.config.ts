...
export const SWAGGER_TAGS = {
  ...
  AUTH: {
    name: 'Autenticação',
    description: 'Endpoints para autenticação de usuários, geração e renovação de tokens JWT, alteração de senhas e logout.'
  },

  // Recuperação de Senha
  PASSWORD_RESET: {
    name: 'Recuperação de Senha',
    description: 'Endpoints para recuperação e redefinição de senhas de usuários.'
  },

  // Gestão de Cidadãos (consolidado)
  CIDADAOS: {
    name: 'Cidadão',
    description: 'Gestão completa de dados dos cidadãos, incluindo informações pessoais, composição familiar, dados sociais, informações bancárias e documentação.'
  },
  ...
  TIPOS_BENEFICIO: {
    name: 'Benefícios',
    description: 'Configuração e gestão dos tipos de benefícios eventuais disponíveis no sistema, incluindo critérios de elegibilidade e valores.'
  },

  // Dados específicos de benefícios (consolidados)
  DADOS_BENEFICIO: {
    name: 'Benefícios',
    description: 'Gestão de dados gerais e específicos dos benefícios, incluindo auxílio natalidade, aluguel social, cesta básica e auxílio funeral.'
  },
  ...
  SOLICITACOES: {
    name: 'Solicitação',
    description: 'Gestão completa do ciclo de vida das solicitações de benefícios, desde a criação até a aprovação ou rejeição.'
  },
  ...
  DOCUMENTOS: {
    name: 'Documentos',
    description: 'Upload, validação, download e gestão de documentos anexados às solicitações de benefícios.'
  },

  // Relatórios e Analytics
  RELATORIOS: {
    name: 'Relatórios',
    description: 'Geração de relatórios gerenciais, dashboards e métricas para acompanhamento e análise do sistema.'
  },

  // Usuários e Perfis
  USUARIOS: {
    name: 'Usuários',
    description: 'Gestão de usuários do sistema, perfis de acesso e permissões para analistas e administradores.'
  },

  // Configurações do Sistema
  CONFIGURACOES: {
    name: 'Configuração',
    description: 'Configurações gerais do sistema, parâmetros operacionais e customizações administrativas.'
  },

  // Auditoria e Logs
  AUDITORIA: {
    name: 'Auditoria',
    description: 'Registro de ações, logs de sistema e trilhas de auditoria para compliance e rastreabilidade.'
  },

  // Logs do Sistema
  LOGS: {
    name: 'Logs',
    description: 'Gestão e consulta de logs do sistema para debugging e monitoramento.'
  },

  // Notificações
  NOTIFICACOES: {
    name: 'Notificações',
    description: 'Sistema de notificações por email, SMS e push para usuários e beneficiários.'
  },

  // Integrações Externas
  INTEGRACOES: {
    name: 'Integradores',
    description: 'APIs para integração com sistemas externos, órgãos governamentais e serviços de terceiros.'
  },

  // Métricas e Monitoramento (consolidado)
  METRICAS: {
    name: 'Métricas e Dashboard',
    description: 'Coleta, análise e visualização de métricas do sistema, dashboards, indicadores de performance e monitoramento operacional.'
  },
  ...
  PAGAMENTOS: {
    name: 'Pagamentos',
    description: 'Gestão completa de pagamentos de benefícios, incluindo controle financeiro, integração bancária, comprovantes e confirmações de recebimento.'
  },
  ...
  RECURSOS: {
    name: 'Recursos',
    description: 'Gestão de recursos administrativos contra decisões de benefícios.'
  },
  ...
  API_EXEMPLO: {
    name: 'api-exemplo',
    description: 'Endpoints de exemplo para demonstração de integração com sistemas externos.'
  }
} as const;
 ...
 */
export function getTagsByGroup(groupName: keyof typeof SWAGGER_TAG_GROUPS): string[] {
