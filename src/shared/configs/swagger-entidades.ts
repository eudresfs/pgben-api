...
export const beneficioSchema = {
  ...
  properties: {
    ...
    ativo: {
      ...
      description: 'Indica se o benefício está ativo e disponível para solicitação'
    },
    criadoEm: {
      type: 'string',
      format: 'date-time',
...
export const solicitacaoSchema = {
  ...
  properties: {
    ...
    status: {
      type: 'string',
      enum: ['PENDENTE', 'APROVADA', 'REJEITADA', 'CANCELADA', 'SUSPENSA', 'ENCERRADA'],
    ...
    valorConcedido: {
      ...
      description: 'Valor concedido do benefício (pode ser diferente do valor base)'
    },
    observacoes: {
      type: 'string',
...
export const ocorrenciaSchema = {
  ...
  properties: {
    ...
    tipo: {
      type: 'string',
      enum: ['ALTERACAO_STATUS', 'OBSERVACAO', 'DOCUMENTO_ADICIONADO', 'DOCUMENTO_VALIDADO', 'NOTIFICACAO_ENVIADA'],
...
export const healthCheckSchema = {
  ...
  properties: {
    ...
    ambiente: {
      ...
      description: 'Ambiente de execução (desenvolvimento, homologação, produção)'
    },
    banco: {
      type: 'object',
      properties: {
