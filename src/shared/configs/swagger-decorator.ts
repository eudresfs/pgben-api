 ...
 */
export const ApiPaginatedResponse = (description: string, exampleResponse: any) => {
  return ApiResponse({
    status: 200,
    description,
    schema: {
 ...
 */
export const ApiCreateEndpoint = (summary: string, examplePayload: any, exampleResponse: any) => {
  return (target: any, key: string, descriptor: PropertyDescriptor) => {
    ...
    ApiResponse({ status: 400, description: 'Dados inválidos' })(target, key, descriptor);
    return descriptor;
  };
};
 ...
 */
export const ApiUpdateEndpoint = (summary: string, examplePayload: any, exampleResponse: any) => {
  return (target: any, key: string, descriptor: PropertyDescriptor) => {
    ApiOperation({ summary })(target, key, descriptor);
    ApiParam({ name: 'id', description: 'ID do registro' })(target, key, descriptor);
    ApiBody({
    ...
    ApiResponse({ status: 400, description: 'Dados inválidos' })(target, key, descriptor);
    ApiResponse({ status: 404, description: 'Registro não encontrado' })(target, key, descriptor);
    return descriptor;
  };
};
 ...
 */
export const ApiActionEndpoint = (summary: string, examplePayload: any = null, exampleResponse: any) => {
  return (target: any, key: string, descriptor: PropertyDescriptor) => {
    ApiOperation({ summary })(target, key, descriptor);
    ApiParam({ name: 'id', description: 'ID do registro' })(target, key, descriptor);
    ...
    ApiResponse({ status: 400, description: 'Não foi possível realizar a ação' })(target, key, descriptor);
    ApiResponse({ status: 404, description: 'Registro não encontrado' })(target, key, descriptor);
    return descriptor;
  };
};
