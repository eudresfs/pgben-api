...
export class CreateCidadaoStructureConsolidado1000001 implements MigrationInterface {
  name = 'CreateCidadaoStructureConsolidado1000001';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ...
      CREATE TYPE "tipo_beneficio_social_enum" AS ENUM ('pbf', 'bpc', 'pcd');
      CREATE TYPE "pix_tipo_enum" AS ENUM ('cpf', 'email', 'telefone', 'chave_aleatoria');
      
      -- Tipo moradia já com o valor 'abrigo' incluído
    ...
    // Criação de índices para a tabela de cidadãos
    ...
    // Criação de índices para a tabela de membros da família
    await queryRunner.createIndex(
      'membro_familia',
      new TableIndex({
    ...
    // Criação de índices para a tabela de benefícios sociais
    await queryRunner.createIndex(
      'beneficio_social',
      new TableIndex({
    ...
    // Criação de índices para a tabela de informações bancárias
    await queryRunner.createIndex(
      'info_bancaria',
      new TableIndex({
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.dropForeignKey('membro_familia', 'FK_membro_familia_cidadao');
    ...
    await queryRunner.dropIndex('membro_familia', 'IDX_membro_familia_cidadao_id');
    ...
    await queryRunner.dropTable('membro_familia');
